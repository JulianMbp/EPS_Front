            ...
            <div className="border justify-center flex items-center h-screen w-screen">
                <div className="grid justify-center items-center grid-cols-3 border rounded-lg text-xl border-blue-400 shadow-lg">
                    ...
                    <h1 className="">
                        ...
                        <label className="block ">
                            {/* entrada de texto al titulo */}
                            <input type="text" name="Efectivo" className="h-full px-3 py-2 bg-white border border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Metodo de Pago" />
                        </label>
                        </div>
                    </div>
                    <div className="col-span-3 flex gap-4 text-left p-5">
                        ...
                        <label className="block ">
                            {/* entrada de texto al titulo */}
                            <input type="text" name="Descuento" className="h-full px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Descuento en decimales" />
                        </label>
                        </div>
                    </div> 
                    <div className="col-span-3 flex gap-4 text-left p-5">
